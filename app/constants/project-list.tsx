export const projects = [
  ...
  },
  {
    ...
    description: 'Version 2 of the ticketing application.',
  },
...
export const hobbyProjects = [
  {
    image: '/quadmor1.png',
    name: 'Quadmor Portfolio v1',
    technologies: ['React', 'Next.js', 'Tailwind CSS', 'Mantine UI'],
    // info: 'Open on a large screen device, app is not responsive',
    codeLink: '',
    liveLink: 'https://q-morin-portfolio.vercel.app/',
    description:
